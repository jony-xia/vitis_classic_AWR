...
#define RESET_PIN_0      54    // SPI0对应AWR2243的nRESET引脚编号
#define RESET_PIN_1      56    // SPI1对应AWR2243的nRESET引脚编号
#define IRQ_PIN_0        55    // SPI0对应AWR2243的IRQ引脚编号
#define IRQ_PIN_1        57    // SPI1对应AWR2243的IRQ引脚编号
